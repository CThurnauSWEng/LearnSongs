	...
	<div class="sky">
		...
		<div class="stars">
			...
			<div class="genericForm">
				...
				<h4>Edit the language for lyrics for ${song.title }</h4>
			
				<p><form:errors path="lyric.*"></form:errors>
				<p>${error }</p>
			
				<form:form action="/processEditLanguage/${lyric.id }" method="POST" modelAttribute="lyric">
					...
					<div class="inputDiv">
						<form:input type="text" path="language" value="${language.id }"/>
